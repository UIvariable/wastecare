...
import 'package:new_app/view/widgets/productpageWidgets/dividerWithText.dart';
...
class _LocationSearchState extends State<LocationSearch> {
  ...
  final List<Place> _suggestedList = [
    Place(
        "Strada Alexandru Vaida Voevod, Cluj-Napoca, Romania",
        "EjNTdHJhZGEgQWxleGFuZHJ1IFZhaWRhIFZvZXZvZCwgQ2x1ai1OYXBvY2EsIFJvbWFuaWEiLiosChQKEgkTi790OgxJRxHjCTPz7FG5pBIUChIJEwS3GEcMSUcRzvVwgxm-DMo",
        [46.7705618, 23.6271447]),
    Place(
        "Piața Unirii, Cluj-Napoca, Romania",
        "EiNQaWHIm2EgVW5pcmlpLCBDbHVqLU5hcG9jYSwgUm9tYW5pYSIuKiwKFAoSCel7XWidDklHEcv8D6rUOV-mEhQKEgnjYLcLnQ5JRxGorzS2ygmgAQ",
        [46.76932799999999, 23.5892818]),
    Place(
        "Bulevardul 21 Decembrie 1989, Cluj-Napoca, Romania",
        "EjJCdWxldmFyZHVsIDIxIERlY2VtYnJpZSAxOTg5LCBDbHVqLU5hcG9jYSwgUm9tYW5pYSIuKiwKFAoSCae2N-0hDElHEdceVADTgD7FEhQKEgnLhnMsHwxJRxEfM72ig0vxBA",
        [46.7753008, 23.6029601]),
    Place(
        "Strada Izlazului, Cluj-Napoca, Romania",
        "EiZTdHJhZGEgSXpsYXp1bHVpLCBDbHVqLU5hcG9jYSwgUm9tYW5pYSIuKiwKFAoSCSWujeN6DklHESR55ms9-Ee7EhQKEgnN8ZIWZg5JRxGMMN0-spd-FA",
        [46.7554258, 23.5602967]),
    Place(
        "Piața Mărăști, Cluj-Napoca, Romania",
        "EidQaWHIm2EgTcSDcsSDyJl0aSwgQ2x1ai1OYXBvY2EsIFJvbWFuaWEiLiosChQKEgnDtD2sEAxJRxGzk4sxT8z_8RIUChIJy4ZzLB8MSUcRHzO9ooNL8QQ",
        [46.7772119197085, 23.6133985197085])
  ];
